...
public class TestStrings {
    ...
    public void test_equals() {
        Assertions.assertThrows(
                ...
                () -> Strings.equals("A", "A", () -> {
                    throw new RuntimeException("Function executed when two Strings are equal");
                }));
        Strings.equals("A", "a", () -> {
            throw new RuntimeException("Function won't execute when two Strings are equal with ignore case");
        });
        Strings.equals("A", "B", () -> {
            throw new RuntimeException("Function won't execute when two Strings are not equal");
        });
    }
    ...
    public void test_notEquals() {
        Assertions.assertThrows(
                RuntimeException.class,
                () -> Strings.notEquals("A", "B", () -> {
                    throw new RuntimeException("Function executed when two Strings are not equal");
                }));
        Strings.notEquals("A", "A", () -> {
            throw new RuntimeException("Function won't execute when two Strings are equal");
        });
    }
    ...
    public void test_equalsIgnoreCaseWithExecutableFunction() {
        Assertions.assertThrows(
                RuntimeException.class,
                () -> Strings.equalsIgnoreCase("A", "A", () -> {
                    throw new RuntimeException("Function executed when two Strings are equalsIgnoreCase");
                }));
        Assertions.assertThrows(
                RuntimeException.class,
                () -> Strings.equalsIgnoreCase("A", "a", () -> {
        ...
        Strings.equalsIgnoreCase("A", "b", () -> {
            throw new RuntimeException("Function won't execute when two Strings are not equalsIgnoreCase");
        });
    }
    ...
    public void test_notEqualsIgnoreCase() {
        Assertions.assertThrows(
                RuntimeException.class,
                () -> Strings.notEqualsIgnoreCase("A", "B", () -> {
                    throw new RuntimeException("Function executed when two Strings are not equalsIgnoreCase");
                }));
        Assertions.assertThrows(
                RuntimeException.class,
                () -> Strings.notEqualsIgnoreCase("A", "b", () -> {
        ...
        Strings.notEqualsIgnoreCase("A", "a", () -> {
            throw new RuntimeException("Function won't execute when two Strings are equalsIgnoreCase");
        });
    }
}
