...
public class TestFiles {
    ...
    public void test_writeToFile_2() {
        ...
        Assertions.assertThrows(
                NullPointerException.class, () -> Files.writeToFile(new File(getTemporaryFilePath()), null));
    }
    ...
    public void test_appendToFile_3() {
        ...
        Assertions.assertThrows(
                NullPointerException.class, () -> Files.appendToFile(new File(getTemporaryFilePath()), null, false));
    }
